...
VIOLATION_KEYWORDS = {
    ...
    "not actually": ViolationType.STANDARDS_OF_IDENTITY,
    "imitation": ViolationType.STANDARDS_OF_IDENTITY,
    "slack fill": ViolationType.STANDARDS_OF_IDENTITY,
    "not ice cream": ViolationType.STANDARDS_OF_IDENTITY,
    "not yogurt": ViolationType.STANDARDS_OF_IDENTITY,
    "not cheese": ViolationType.STANDARDS_OF_IDENTITY,
    "not honey": ViolationType.STANDARDS_OF_IDENTITY,
    "not chocolate": ViolationType.STANDARDS_OF_IDENTITY,
    "not vanilla": ViolationType.STANDARDS_OF_IDENTITY,
    "not mayo": ViolationType.STANDARDS_OF_IDENTITY,
    "not butter": ViolationType.STANDARDS_OF_IDENTITY,
    "not olive oil": ViolationType.STANDARDS_OF_IDENTITY,
    "not maple": ViolationType.STANDARDS_OF_IDENTITY,
    "contains no real": ViolationType.STANDARDS_OF_IDENTITY,
    "100% pure": ViolationType.STANDARDS_OF_IDENTITY,
    "made with real": ViolationType.STANDARDS_OF_IDENTITY,
}
